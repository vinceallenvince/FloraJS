...
import { System, Utils, Vector } from './vendor/burner/main';
 ...
 */
export default class Agent extends Mover {
   ...
   *
   * @returns This object's acceleration vector.
   */
  applyAdditionalForces(): Vector {
   ...
   * to avoid all items.
   *
   * @param items An array of Flora items.
   * @returns A force to apply.
   */
  _separate(items: any[]): Vector {
