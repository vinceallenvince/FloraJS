...
test('load Repeller.', () => {
  expect(Repeller).toBeTruthy();
});

test('new Repeller() should have default properties.', () => {
  ...
  expect(obj.name).not.toBe('Repeller');
  ...
  expect(obj.color[0] === 250 && obj.color[1] === 105 && obj.color[2] === 0).toBeTruthy();
  ...
  expect(obj.boxShadowColor[0] === 250 && obj.boxShadowColor[1] === 105 && obj.boxShadowColor[2] === 0).toBeTruthy();
  expect(obj.opacity).toBe(0.75);
  expect(obj.zIndex).toBe(1);
});

test('new Repeller() should have custom properties.', () => {
  Burner.System.Classes = {
    Repeller: Repeller
  };
...
test('draw() should assign a css test string to the style property.', () => {
  ...
  Burner.System.setup(function() {
    ...
    expect(obj.el.style.backgroundColor).toBe('rgb(250, 105, 0)');
