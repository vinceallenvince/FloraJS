 ...
 */
export default class Sensor extends Mover {
  ...
  getBehavior(): any {
    ...
    switch (this.behavior) {
      ...
      case 'CONSUME':
        return function(this: any, sensor: any, target: any) {
   ...
   * target is a circle.
   *
   * @param target The stimulator.
   * @return true if sensor's range intersects target.
   */
  _sensorActive(target: any, opt_sensitivity?: number): boolean {
