...
var elements = function() {
  ...
  function BVehicleALIVE(exports, opt_options) {
    ...
    var clrHeat = defaultColors.getColor('heat').startColor,
        clrCold = defaultColors.getColor('cold').startColor;
    ...
    this.vehicle = new exports.Mover({
      ...
      wrapEdges: true,
      sensors: [this.sensorHeat, this.sensorCold],
  ...
  var bv1 = new BVehicleALIVE(Flora, {
    controlCamera: true,
    color: [255, 255, 255],
    eyeColor: [90, 90, 90]
  });
  ...
  for (i = 0, max = (0.025 * world.width); i < max; i += 1) {
