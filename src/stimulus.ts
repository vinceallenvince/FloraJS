...
import { Utils } from './vendor/burner/main';
 ...
 * @extends Mover
 */
export default class Stimulus extends Mover {
  /**
   ...
   * @type {Array}
   */
  static borderStyles: string[] = ['double', 'double', 'dotted', 'dashed'];
  static palettes: { [key: string]: any } = {};
  static borderColors: { [key: string]: any } = {};
  static boxShadowColors: { [key: string]: any } = {};
  static borderPalette: any;
